    ...
    const columns = [
      {
        title: "Product Code",
        dataIndex: "product",
        render: (key: any) => key?.productCode ?? "",
      },
      {
        title: "Product Name",
        dataIndex: "product",
        render: (key: any) => key?.title ?? "",
      },
      {
        title: "Author",
        dataIndex: "product",
        render: (key: any) => key?.author ?? "",
      },
      {
        title: "Purchase Price",
        dataIndex: "pricing",
        render: (key: any) => key?.purchasePrice ?? "",
      },
      {
        title: "Original Price",
        dataIndex: "pricing",
        render: (key: any) => key?.originalPrice ?? "",
      },
      {
        title: "Discount",
        dataIndex: "pricing",
        render: (pricing: any) =>
          pricing?.discountPercentage ? `${pricing.discountPercentage}%` : "",
      },
      {
        title: "Discount Price",
        dataIndex: "pricing",
        key: "price",
        render: (key: any) => key?.discountPrice ?? "",
      },
      {
        title: "Stock",
        dataIndex: "specifications",
        render: (key: any) => key?.sku ?? "",
      },
      {
        title: "Status",
        dataIndex: "status",
        key: "status",
        render: (key: string) => formatCamelCaseToTitleCase(key),
      },
      {
        ...
        >
          <Table
            ...
            pagination={{
              ...
              onChange: async (pageNo, perPageNo) =>
                setState({
                  ...state,
                  page: pageNo,
                  perPage: perPageNo,
