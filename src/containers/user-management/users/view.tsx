...
import { UserRes } from "@redux/services/user-management/users/type";
                                ...
                                <Row gutter={[24, 24]}>
                                    <Col xs={24}>
                                        ...
                                        <div style={{ marginBottom: '24px', textTransform: 'capitalize' }}>
                                            ...
                                            {data.role && <Tag color="purple">{data.role.name}</Tag>}
                                        </div>
                                        ...
                                        <Descriptions column={{ xs: 1, sm: 1, md: 2 }} bordered size="small" style={{ overflowX: 'auto' }}>
                                            ...
                                            {data.department && <Descriptions.Item label="Department">{data.department.name}</Descriptions.Item>}
                                            {data.team && <Descriptions.Item label="Team">{data.team.name}</Descriptions.Item>}
                                        </Descriptions>
                                    </Col>
                                </Row>
                                ...
                                {(data.personal) && (
                                    <>
                                        ...
                                        <Descriptions column={{ xs: 1, sm: 1, md: 2 }} bordered size="small" style={{ overflowX: 'auto' }}>
                                            ...
                                            <Descriptions.Item label="Father's Phone">{data.personal.fathersPhone}</Descriptions.Item>
                                            <Descriptions.Item label="Mother's Name">{data.personal.mothersName}</Descriptions.Item>
                                            <Descriptions.Item label="Mother's Phone">{data.personal.mothersPhone}</Descriptions.Item>
                                        </Descriptions>
                                    </>
                                )}
