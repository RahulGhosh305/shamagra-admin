                    ...
                    <Row>
                        <Col lg={3} sm={6} xs={12} className="align-center-v navbar-brand">
                            <Button type="link" onClick={() => setCollapse(!collapse)}>
                                <img src={`/assets/images/${collapse ? 'right.svg' : 'left.svg'}`} alt="menu" />
                            </Button>
                            <Link href={"/dashboard"} className={!mobileView ? 'striking-logo top-menu' : 'striking-logo'}>
                                <img
                                    alt=""
                                    // src={"/assets/images/logo.png"}
                                    src={"/assets/images/boichirtyo.png"}
                                />
                            </Link>
                        </Col>
                        ...
                        <Col md={0} sm={18} xs={12}>
                            <>
                                <div className="mobile-action">
                                    <Link className="btn-auth" onClick={(e) => {
                                        e.preventDefault();
